...
class FtxClient:
    ...
    def get_fills(self, market:str = None, start_time: float = None, end_time: float = None) -> List[dict]:
        return self._get(f'fills?include_order_details=1&', {'market': market, 'start_time': start_time, 'end_time': end_time})

    # @authentication_required
    # def get_fills(self, limit) -> List[dict]:
    #     return self._get(f'fills?limit=1000')
    ...
    def get_funding_payments(self, start_time: float = None, end_time: float = None) -> List[dict]:
        return self._get(f'funding_payments', {'start_time': start_time, 'end_time': end_time})

    def get_borrow_history(self) -> List[dict]:
        return self._get(f'spot_margin/borrow_history')

    def get_interest_payments(self, start_time: float = None, end_time: float = None) -> List[dict]:
        return self._get(f'interest_payments', {'start_time': start_time, 'end_time': end_time})